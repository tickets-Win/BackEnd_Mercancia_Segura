...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpListado" runat="server" UpdateMode="Always">
                ...
                <div class="card card-shadow p-4 mb-4">
                    <div style="overflow-x: auto; width: 100%;">
                        <asp:GridView ID="gvVendedores" runat="server"
                            ...
                            OnRowDataBound="gvVendedores_RowDataBound">
                            ...
                            <EmptyDataTemplate>
                                <div class="text-muted py-3">No se encontraron vendedores con ese criterio.</div>
                            </EmptyDataTemplate>
                        </asp:GridView>
                    </div>
                </div>
        ...
        <Triggers>
            <%-- Agregar muestra pnlFormularioVendedor, que vive FUERA de este
                 ...
                 tabla se registran en gvVendedores_RowDataBound por lo mismo. --%>
            <asp:PostBackTrigger ControlID="btnAgregarVendedor" />
        </Triggers>
    </asp:UpdatePanel>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            msBuscadorIncremental('<%= txtBuscarVendedor.ClientID %>', '<%= txtBuscarVendedor.UniqueID %>', 400);
        });
    </script>
</asp:Content>
