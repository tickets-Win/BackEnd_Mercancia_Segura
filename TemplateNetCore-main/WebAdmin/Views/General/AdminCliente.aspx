...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="tab-content">
            ...
            <asp:Panel ID="pnlFormularioCliente" runat="server" CssClass="card p-4 mt-4" Visible="false">
                ...
                <div class="row g-3 mt-2">
                    ...
                    <div class="col-md-4">
                        ...
                        <asp:DropDownList ID="ddlRegimenFiscal" CssClass="form-select required" runat="server">
                        </asp:DropDownList>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <asp:DropDownList ID="ddlSeguroContrata" CssClass="form-select required" runat="server">
                        </asp:DropDownList>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <asp:DropDownList ID="ddlOrigenCliente" CssClass="form-select required" runat="server">
                        </asp:DropDownList>
                    </div>

                    <div class="col-md-4">
                        <label class="form-label">Sector</label>
                        <asp:DropDownList ID="ddlSector" CssClass="form-select required" runat="server">
                        </asp:DropDownList>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            ...
                            <div class="card p-3 shadow-sm">
                                <asp:UpdatePanel ID="upCorreos" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label">Correo</label>
                                                            <asp:TextBox ID="txtCorreoAdicional" runat="server"
                                                                CssClass="form-control"
                                                                placeholder="correo@ejemplo.com" TextMode="SingleLine" AutoPostBack="false" autocomplete="off"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <asp:Button ID="btnGuardarCorreo" runat="server"
                                                            ...
                                                            Text="Guardar" OnClick="btnGuardarCorreo_Click" />
                                                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="card p-3 shadow-sm">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <div>
                                        <asp:Button ID="btnAgregarVendedor" CssClass="btn btn-primary btn-add" OnClientClick="return false;" runat="server" data-bs-toggle="modal" data-bs-target="#modalAgregarVendedor" Text="Agregar Vendedor" />
                                    </div>
                                </div>
                                <div class="card card-shadow p-4 mb-4">
                                    <div style="overflow-x: auto; width: 100%;">
                                        <asp:UpdatePanel ID="UpVendedores" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:GridView ID="gvListaVendedores" runat="server"
                                                    ...
                                                    <PagerStyle CssClass="gvPager" HorizontalAlign="Center" />
                                                    <Columns>
                                                        <asp:BoundField DataField="Tipo" HeaderText="Tipo Vendedor" />
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    <h6>Comisión</h6>
                                                                    <asp:TextBox ID="txtComision" runat="server" CssClass="form-control" placeholder="Comisión (%)" ReadOnly="true"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="card p-3 shadow-sm">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-4">
                                    <div>
                                        <asp:Button ID="btnAgregarBeneficiario" CssClass="btn btn-primary btn-add" OnClientClick="return false;" runat="server" data-bs-toggle="modal" data-bs-target="#modalAgregarBeneficiario" Text="Agregar Beneficiario" />
                                    </div>
                                </div>
                                <div class="card card-shadow p-4 mb-4">
                                    <div style="overflow-x: auto; width: 100%;">
                                        <asp:UpdatePanel ID="UpBeneficiarioPrerente" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:GridView ID="GvBeneficiarioPreferente" runat="server"
                                                    CssClass="table table-hover align-middle"
                                                    AutoGenerateColumns="False"
                                                    OnRowCommand="GvBeneficiarioPreferente_RowCommand"
                                                    HeaderStyle-CssClass="table-light"
                                                        ...
                                                        <asp:TemplateField HeaderText="Acciones">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="lnkEliminar" runat="server" CommandName="Eliminar" CommandArgument='<%# Eval("BeneficiarioPreferenteId") %>'
                                                                    CssClass="icon-btn action-icon" ToolTip="Eliminar"
                                                                    OnClientClick="return confirm('¿Seguro que deseas eliminar este beneficiario?');">
                                                                    <i class="bi bi-trash"></i>
                                                                </asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
        ...
        <div class="tab-pane fade" id="panel-credito" role="tabpanel">
            <asp:UpdatePanel ID="updCredito" runat="server">
                <ContentTemplate>
        ...
        <div class="tab-pane fade" id="panel-estado" role="tabpanel">
            <asp:UpdatePanel ID="UpEstadoCuenta" runat="server">
                <ContentTemplate>
