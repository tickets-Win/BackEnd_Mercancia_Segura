...
{
    [ApiController]
    public abstract class TipoContenedorApiControllerBase : ServiceBaseController
    {
        [HttpGet]
        [Route("/{version:apiVersion}/tipoContenedor")]
        [ValidateModelState]
        [SwaggerOperation("GetTipoContenedor")]
        ...
        public abstract Task<IActionResult> GetTipoContenedorApiAsync(
