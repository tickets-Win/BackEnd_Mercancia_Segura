...
{
    [ApiController]
    public abstract class TipoEventoApiControllerBase : ServiceBaseController
    {
        [HttpGet]
        [Route("/{version:apiVersion}/tipoEvento")]
        [ValidateModelState]
        [SwaggerOperation("GetTipoEvento")]
        ...
        public abstract Task<IActionResult> GetTipoEventoApiAsync(
