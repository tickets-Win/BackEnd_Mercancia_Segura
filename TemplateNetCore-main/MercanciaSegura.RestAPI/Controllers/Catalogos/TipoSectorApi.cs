...
{
    [ApiController]
    public abstract class TipoSectorApiControllerBase : ServiceBaseController
    {
        [HttpGet]
        [Route("/{version:apiVersion}/tipoSector")]
        [ValidateModelState]
        ...
        description: "Response to client error satus code")]
        public abstract Task<IActionResult> GetTipoSectorApiAsync(
