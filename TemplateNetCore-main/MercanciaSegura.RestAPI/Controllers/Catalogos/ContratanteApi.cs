...
{
    [ApiController]
    public abstract class ContratanteApiControllerBase : ServiceBaseController
    {
        [HttpGet]
        [Route("/{version:apiVersion}/contratante")]
        [ValidateModelState]
        [SwaggerOperation("GetContratante")]
        ...
        public abstract Task<IActionResult> GetContratanteApiAsync(
