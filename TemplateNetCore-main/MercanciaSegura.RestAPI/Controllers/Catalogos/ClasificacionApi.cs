...
{
    [ApiController]
    public abstract class ClasificacionApiControllerBase : ServiceBaseController
    {
        [HttpGet]
        [Route("/{version:apiVersion}/clasificacion")]
        [ValidateModelState]
        [SwaggerOperation("GetClasificacion")]
        ...
        public abstract Task<IActionResult> GetClasificacionApiAsync(
