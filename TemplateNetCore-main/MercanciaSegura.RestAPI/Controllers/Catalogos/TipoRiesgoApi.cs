...
{
    [ApiController]
    public abstract class TipoRiesgoApiControllerBase : ServiceBaseController
    {
        [HttpGet]
        [Route("/{version:apiVersion}/tipoRiesgo")]
        [ValidateModelState]
        [SwaggerOperation("GetTipoRiesgo")]
        ...
        public abstract Task<IActionResult> GetTipoRiesgoApiAsync(
