...
{
    [ApiController]
    public abstract class EstatusPolizaApiControllerBase : ServiceBaseController
    {
        [HttpGet]
        [Route("/{version:apiVersion}/estatusPoliza")]
        [ValidateModelState]
        [SwaggerOperation("GetEstatusPoliza")]
        ...
        public abstract Task<IActionResult> GetEstatusPolizaApiAsync(
