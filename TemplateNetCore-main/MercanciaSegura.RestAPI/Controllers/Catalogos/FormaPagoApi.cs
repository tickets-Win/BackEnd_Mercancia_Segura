...
{
    [ApiController]
    public abstract class FormaPagoApiControllerBase : ServiceBaseController
    {
        [HttpGet]
        [Route("/{version:apiVersion}/formaPago")]
        [ValidateModelState]
        [SwaggerOperation("GetFormaPago")]
        ...
        public abstract Task<IActionResult> GetFormaPagoApiAsync(
