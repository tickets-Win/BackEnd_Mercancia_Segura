...
{
    [ApiController]
    public abstract class TipoSiniestroApiControllerBase : ServiceBaseController
    {
        [HttpGet]
        [Route("/{version:apiVersion}/tipoSiniestro")]
        [ValidateModelState]
        [SwaggerOperation("GetTipoSiniestro")]
        ...
        public abstract Task<IActionResult> GetTipoSiniestroApiAsync(
