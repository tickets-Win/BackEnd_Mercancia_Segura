...
{
    [ApiController]
    public abstract class SubRamoApiControllerBase : ServiceBaseController
    {
        [HttpGet]
        [Route("/{version:apiVersion}/subramo")]
        [ValidateModelState]
        [SwaggerOperation("GetSubRamo")]
        ...
        public abstract Task<IActionResult> GetSubRamoApiAsync(
