...
{
    [ApiController]
    public abstract class TipoBienApiControllerBase : ServiceBaseController
    {
        [HttpGet]
        [Route("/{version:apiVersion}/tipoBien")]
        [ValidateModelState]
        [SwaggerOperation("GetTipoBien")]
        ...
        public abstract Task<IActionResult> GetTipoBienApiAsync(
