...
{
    [ApiController]
    public abstract class TransitoApiControllerBase : ServiceBaseController
    {
        [HttpGet]
        [Route("/{version:apiVersion}/transito")]
        [ValidateModelState]
        [SwaggerOperation("GetTransito")]
        ...
        public abstract Task<IActionResult> GetTransitoApiAsync(
