...
{
    [ApiController]
    public abstract class RegimenFiscalApiControllerBase : ServiceBaseController
    {
        [HttpGet]
        [Route("/{version:apiVersion}/regimenFiscal")]
        [ValidateModelState]
        [SwaggerOperation("GetRegimenFiscal")]
        ...
        description: "Response to client error satus code")]
        public abstract Task<IActionResult> GetRegimenFiscalApiAsync(
