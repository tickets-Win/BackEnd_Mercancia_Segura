...
{
    [ApiController]
    public abstract class TipoTarifaApiControllerBase : ServiceBaseController
    {
        [HttpGet]
        [Route("/{version:apiVersion}/tipoTarifa")]
        [ValidateModelState]
        [SwaggerOperation("GetTipoTarifaApi")]
        ...
        description: "Response to client error satus code")]
        public abstract Task<IActionResult> GetTipoTarifaApiAsync(
