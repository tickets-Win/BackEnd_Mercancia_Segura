...
{ 
    ...
    public abstract class UsersApiController : ServiceBaseController
    {
        ...
        [SwaggerResponse(statusCode: 400, type: typeof(Models_InlineResponse400), description: "Response to client error satus code")]
        [SwaggerResponse(statusCode: 401, type: typeof(Models_InlineResponse400), description: "Response to client error satus code")]
        [SwaggerResponse(statusCode: 404, type: typeof(Models_InlineResponse400), description: "Response to client error satus code")]
