...
using MercanciaSegura.DOM;
using MercanciaSegura.DOM.Errors;
using MercanciaSegura.Funcionalidad.Functionality;
using InlineResponse400 = MercanciaSegura.RestAPI.Models.InlineResponse400;

namespace MercanciaSegura.RestAPI.Filters;
